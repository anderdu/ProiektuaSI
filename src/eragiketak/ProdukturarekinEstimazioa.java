...
public class ProdukturarekinEstimazioa implements EstimazioaKalkulatu {
	
	private static ProdukturarekinEstimazioa nEstimazioaKalkulatu = null;
	...
	private ProdukturarekinEstimazioa() {
		produktuEredua = new HashMap<Integer, ArrayList<ProduktuInfo>>();
		antzekotasun = new Kosinua();
	}
	
	public static synchronized ProdukturarekinEstimazioa getEstimazioaKalkulatu() {
		if(ProdukturarekinEstimazioa.nEstimazioaKalkulatu == null)
			ProdukturarekinEstimazioa.nEstimazioaKalkulatu = new ProdukturarekinEstimazioa();
		return ProdukturarekinEstimazioa.nEstimazioaKalkulatu;
	}
